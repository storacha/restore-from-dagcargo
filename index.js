 ...
 */
const findAggregate = async (spinner, db, root) => {
 ...
 */
const downloadAggregate = async (spinner, srcURL, destPath) => {
 ...
 * @param {string} destPath
 */
const indexCAR = async (spinner, srcPath, destPath) => {
 ...
 * @param {string} destPath
 */
const extractDAG = async (spinner, srcPath, indexPath, root, destPath) => {
  let shard
 ...
 * @param {UnknownLink} root
 */
const storeDAG = async (spinner, storage, srcPath, root) => {
